...
public static class DrillInteractionProtocolCatalog
{
    ...
    [
        Protocol(
            ...
            "Eyes open. Look at the visible shape normally. That is the whole task.",
            "Place the phone so you can tap without moving your gaze.",
            "If attention follows a thought, sound, feeling, or anything else, that is WANDERED: tap anywhere once. Then look back at the shape; there is no second action to record.",
            ...
            ("RESUME", "A brief flash confirms the tap. Look back at the shape; no second tap.")),
        Protocol(
            DrillId.FH2DistractorHold,
            DrillInteractionInputKind.FocusWanderSurface,
            "Eyes open. Look at the target normally and let distractors pass without answering them.",
            "Place the phone so you can tap without moving your gaze.",
            "When attention leaves the target, that is WANDERED: tap anywhere once, then look back at it without another tap.",
            ...
            ("WANDERED", "If attention leaves the target, tap anywhere once. A brief flash confirms the tap; look back at the target.")),
        Protocol(
